...
# Form implementation generated from reading ui file 'mycourse.ui'
#
...
from PyQt5.QtWidgets import QWidget, QApplication, QHeaderView, QAbstractItemView, QTableWidgetItem
...
class MyCoursePage(QWidget, Ui_MyCourse):
